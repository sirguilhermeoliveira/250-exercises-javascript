(() => {
  // (function() {}()); basicamente IIFE você envolta as funções no projeto todo
  /*
...
*/
  ...
  var subtraction = calculadora(1, 2);
  var multiplication = calculadora(3, 4);
  var division = calculadora(5, 6);
  var mod = calculadora(5, 6);
