...
console.log(
  'Link do repositório: https://github.com/sirguilhermeoliveira/cars-js-ninja/'
);
console.log(
  'Link do pull request: https://github.com/sirguilhermeoliveira/cars-js-ninja/pull/1'
);
