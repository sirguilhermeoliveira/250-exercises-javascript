...
*/
  ...
  let jose = new Person('jose', 'silva', 18);
  let paulo = new Person('paulo', 'silva', 19);
  let carlos = new Person('carlos', 'silva', 20);
...
*/
  ...
  console.log(`${paulo.getFullName()} agora tem ${paulo.getAge()} anos.`);
  console.log(`${carlos.getFullName()} agora tem ${carlos.getAge()} anos.`);
})();
